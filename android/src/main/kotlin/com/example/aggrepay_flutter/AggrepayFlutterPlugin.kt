package com.example.aggrepay_flutter
...
class AggrepayFlutterPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "aggrepay_flutter")
...
//import io.flutter.plugin.common.MethodChannel.Result
//
///** AggrepayFlutterPlugin */
//class AggrepayFlutterPlugin: FlutterPlugin, MethodCallHandler {
//  /// The MethodChannel that will the communication between Flutter and native Android
//  ///
//  /// This local reference serves to register the plugin with the Flutter Engine and unregister it
//  /// when the Flutter Engine is detached from the Activity
